...
|---|------------|-----------------|---------------|------------|--------|---------------|
| 1 | Auth and privacy regression floor | Defend magic-link auth, redirects, replay, generic responses, and email/token privacy at the cheapest layer. | #1, #2 | integration + service | complete | testing-auth-privacy-regression-floor |
